var circularQueue = /** @class */ (function () {
    function circularQueue(capacity) {
        this.enqueueQueue = enqueueQueue;
        this.dequeueQueue = dequeueQueue;
        this.peekFront = peekFront;
        this.peekRear = peekRear;
...
function dequeueQueue() {
    ...
    var data = this.arr[this.frontofQueue];
...
function printQueue() {
    ...
    var str = "";
    for (var i = this.frontofQueue; i < this.rearofQueue; i++) {
        str += this.arr[i] + " ";
    }
    return str;
}
